...
public final class PluginCompatibilityCitizens extends BasePluginCompatibility {
    ...
    private static final ClassReflectionReferenceResolver citizensPluginCitizensEntityTrackerClassResolver = new ClassReflectionReferenceResolver("net.citizensnpcs.nms.v1_20_R1.util.CitizensEntityTracker");

    private static final ClassReflectionReferenceResolver citizensPluginEntityHumanNPCClassResolver = new ClassReflectionReferenceResolver("net.citizensnpcs.nms.v1_20_R1.entity.EntityHumanNPC");
